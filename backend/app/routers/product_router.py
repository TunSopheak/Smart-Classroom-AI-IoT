...
def check_required_pages() -> list[dict]:
    pages = [
        ...
        ("Monitoring Workspace", "/dashboard/monitoring-workspace"),
...
def system_health_page(request: Request):
    ...
    readiness_items = [
        ...
        {"module": "Monitoring Workspace", "status": "Ready", "notes": "Main live classroom stream with FACE, YOLO, behavior, IoT, and optional recording."},
