...
if "Phase 10 Behavior Detection Engine" not in css_text:
    css_text += r"""
...
# Docs
write_file("docs/behavior_detection_engine.md", r"""
# Phase 10 Behavior Detection Engine
...
print("")
print("DONE: Phase 10 Behavior Detection Engine applied.")
